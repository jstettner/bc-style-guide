<div id="forms" class="prm pll catagory width-100">
  ...
  <form role="form" name="accountForm" autocomplete="off" novalidate="novalidate" data-preflight-tag="AccountForm" class="bc-form width-70" style="margin-left:15%;margin-right:15%;">
