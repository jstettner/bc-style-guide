<div class="flex-column">
  <div class="flex-row ph-80 flex-column-mobile">
    <div class="flex-column width-50 width-50-tablet width-100-mobile pr-80 ph-30-tablet pln">
      ...
      <hr>
      <div class="flex-row flex-between flex-column-mobile flex-column-tablet">
        ...
        <div id="tooltip-help" class="flex-row flex-end flex-start-mobile flex-start-tablet pv-10-mobile pv-10-tablet">
