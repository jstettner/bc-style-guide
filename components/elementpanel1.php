          ...
          <div class="popover top message-contextual">
            ...
            <div class="popover-inner">
              <div class="popover-content">
                <p class="mbn type-sm text-center">This rate will expire after 10 minutes. If that happens please restart your trade.</p>
              </div>
            </div>
          </div>
        ...
        <div class="popover-inner">
          ...
          <div class="popover-content" style="background-color:white;">
            <li><h4>Send and Receive Ether <small class="border-grey mlm">7/24/17</small></h4>
              <p>
                <span>You can now send and receive ether from your Blockchain wallet!</span>
              </p>
            </li>
          </div>
        </div>
